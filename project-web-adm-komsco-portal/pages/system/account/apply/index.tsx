              ...
              <Table sx={{ minWidth: 700 }} aria-label="customized table">
                <TableHead>
                  <TableRow>
                    ...
                    <StyledTableCell align="center">신청일</StyledTableCell>
                  ...
                  {accountapp.map((ares, index) => {
                    return (
                      <TopStyledTableRow key={index}>
                        ...
                        <TopStyledTableCell align="left">{ares.membNm}</TopStyledTableCell>
                        <TopStyledTableCell align="center">{ares.mngrAppcStaNm}</TopStyledTableCell>
                        <TopStyledTableCell align="center">{ares.acntTypNm}</TopStyledTableCell>
                        <TopStyledTableCell align="center">{ares.frstRgsrId}</TopStyledTableCell>
                        <TopStyledTableCell align="center">{ares.frstRegDttm}</TopStyledTableCell>
                      </TopStyledTableRow>
                    );
                  })}
                </TableBody>
...
User.getLayout = (page, navItems) => {
  return (
    <PrimaryLayout title={'계정신청내역'} navItems={navItems}>
      {page}
    </PrimaryLayout>
  );
};
