      ...
      <section>
        ...
        <div className={styles.tabmenuSearch}>
          <div className={`${styles.bl_middleWrap_left}`}>
            <a href="./accountapp">
              <button className={styles.cursor}>관리자계정등록</button>
            </a>
          </div>
                  ...
                  {accountapp.map((ares, index) => {
                    return (
                      <TopStyledTableRow key={index}>
                        <StyledTableCell align="center">{ares.mngrNo}</StyledTableCell>
                        <StyledTableCell align="center">{ares.mngrId}</StyledTableCell>
                        <StyledTableCell align="center">{ares.mngrNm}</StyledTableCell>
                        <StyledTableCell align="center">-</StyledTableCell>
                        <StyledTableCell align="center">{ares.mngrGroupNm}</StyledTableCell>
                        <StyledTableCell align="center">{ares.gftcList.areaSrvcId}</StyledTableCell>
                        <StyledTableCell align="center">-</StyledTableCell>
                        <StyledTableCell align="center">{ares.uzYn}</StyledTableCell>
                        <StyledTableCell align="center">{ares.frstRegDttm}</StyledTableCell>
                        <StyledTableCell align="center">{ares.frstRgsrNm}</StyledTableCell>
                      </TopStyledTableRow>
                    );
                  })}
                </TableBody>
...
User.getLayout = (page, navItems) => {
  return (
    <PrimaryLayout title={'관리자 계정 관리'} navItems={navItems}>
      {page}
    </PrimaryLayout>
  );
};
