...
const CardCompanyIssued: NextPageWithLayout = () => {
          ...
          <Table sx={{ minWidth: 700 }} aria-label="customized table">
            <TableHead>
              <TableRow>
                ...
                <StyledTableCell align="center">농협</StyledTableCell>
                <StyledTableCell align="center">우체국</StyledTableCell>
                <StyledTableCell align="center">신한</StyledTableCell>
                <StyledTableCell align="center">전북</StyledTableCell>
                <StyledTableCell align="center">새마을금고</StyledTableCell>
                <StyledTableCell align="center">신협</StyledTableCell>
                <StyledTableCell align="center">우리</StyledTableCell>
            ...
            <TableBody>
              {items.map((row) => (
                <StyledTableRow key={row.id}>
                  ...
                  <StyledTableCell align="center">{row.nhIssuCcnt}</StyledTableCell>
                  <StyledTableCell align="center">{row.epIssuCcnt}</StyledTableCell>
                  <StyledTableCell align="center">{row.shIssuCcnt}</StyledTableCell>
                  <StyledTableCell align="center">{row.jbIssuCcnt}</StyledTableCell>
                  <StyledTableCell align="center">{row.mgIssuCcnt}</StyledTableCell>
                  <StyledTableCell align="center">{row.cuAcmlIssuCcnt}</StyledTableCell>
                  <StyledTableCell align="center">{row.wrIssuCcnt}</StyledTableCell>
                  <StyledTableCell align="center">{row.totIssuCcnt}</StyledTableCell>
                </StyledTableRow>
              ))}
            </TableBody>
          </Table>
...
export default CardCompanyIssued;

CardCompanyIssued.getLayout = (page, navItems) => {
  return (
    <PrimaryLayout title={'카드사별 발급통계'} navItems={navItems}>
      {page}
    </PrimaryLayout>
  );
};
