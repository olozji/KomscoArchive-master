...
import PymntBase from './components/pymntbase';
import StlmnBase from './components/stlmnbase';
import Pagination from '../../../components/pagination/Pagination';

const Mrchn: NextPageWithLayout = () => {
...
Mrchn.getLayout = (page, navItems) => {
  return (
    <PrimaryLayout title={'가맹점 통계'} navItems={navItems}>
      {page}
    </PrimaryLayout>
  );
};
