...
const KoreaBankReport: NextPageWithLayout = () => {
  ...
  const fetchKorBnk = async () => {
    console.log('한국은행 제출자료');
    ChargeService.KoreaBnkReport({
      schSdate: '20220101',
      schEdate: '20230101',
      pageNum: 1,
      pageSize: 10,
        ...
        <TableContainer component={Paper}>
          <Table sx={{ minWidth: 800 }} aria-label="customized table">
            <TableHead>
              ...
              <TableRow>
                <StyledTableCell align="center">오프라인</StyledTableCell>
                <StyledTableCell align="center">온라인(원격결제)</StyledTableCell>
                <StyledTableCell align="center">온라인(부가서비스)</StyledTableCell>
                <StyledTableCell align="center">오프라인</StyledTableCell>
                <StyledTableCell align="center">온라인(원격결제)</StyledTableCell>
                <StyledTableCell align="center">온라인(부가서비스)</StyledTableCell>
              </TableRow>
            ...
            <TableBody>
              {items.map((row) => (
                <StyledTableRow key={row.id}>
                  ...
                  <StyledTableCell align="center">{row.oflnSetlCcnt}</StyledTableCell>
                  <StyledTableCell align="center">{row.onlnSetlCcnt}</StyledTableCell>
                  <StyledTableCell align="center">{row.onlnAdiSetlCcnt}</StyledTableCell>
                  <StyledTableCell align="center">{row.oflnSetlAmt}</StyledTableCell>
                  <StyledTableCell align="center">{row.onlnSetlAmt}</StyledTableCell>
                  <StyledTableCell align="center">{row.onlnAdiSetlAmt}</StyledTableCell>
...
export default KoreaBankReport;

KoreaBankReport.getLayout = (page, navItems) => {
  return (
    <PrimaryLayout title={'한국은행 제출자료'} navItems={navItems}>
      {page}
    </PrimaryLayout>
  );
};
