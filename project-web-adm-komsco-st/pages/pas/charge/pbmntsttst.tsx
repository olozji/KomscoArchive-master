...
const pbmntSttst: NextPageWithLayout = () => {
      ...
      <div className="bl_content_filterWrap">
        ...
        <div className="bl_content_filterWrap_top">
          ...
          <Autocomplete
            ...
            className="autoCompleteStyle el_input_select3 el_input_lg hp_mr-15 "
          ...
          <Table sx={{ minWidth: 700 }} aria-label="customized table">
            <TableHead>
              <TableRow>
                ...
                <StyledTableCell align="center" rowSpan={2}></StyledTableCell>
              </TableRow>

              <TableRow>
                <StyledTableCell align="center">총 판매예산</StyledTableCell>
                <StyledTableCell align="center">할인판매예산(캐시백)</StyledTableCell>
                <StyledTableCell align="center">판매금액합계</StyledTableCell>
                <StyledTableCell align="center">선할인판매(캐시백)</StyledTableCell>
                <StyledTableCell align="center">할인금액(캐시백율)</StyledTableCell>
                <StyledTableCell align="center">일반판매금액</StyledTableCell>
                <StyledTableCell align="center">총 판매예산</StyledTableCell>
                <StyledTableCell align="center">할인판매예산</StyledTableCell>
                <StyledTableCell align="center">판매금액합계</StyledTableCell>
                <StyledTableCell align="center">선할인판매(인센티브)</StyledTableCell>
                <StyledTableCell align="center">할인금액(인센티브)</StyledTableCell>
                <StyledTableCell align="center">일반판매금액</StyledTableCell>
              </TableRow>
            </TableHead>
            {items.length === 0 ? (
                ...
                {items.map((row) => (
                  <StyledTableRow key={row.id}>
                    <StyledTableCell align="center">
                      {dateFormat(params.schTrmSrchDiv, row.gdsIssuDt)}
                    </StyledTableCell>
                    <StyledTableCell align="center">
                    ...
                    <StyledTableCell align="center">
                      {numberWithCommas(row.totSleBdgtAmt)}
                    </StyledTableCell>
                    <StyledTableCell align="center">
                      {numberWithCommas(row.totDcSleBdgtAmt)}
                    </StyledTableCell>
                    <StyledTableCell align="center">{}</StyledTableCell>
                    <StyledTableCell align="center">
                      {numberWithCommas(row.mblPdscAmt)}
                    </StyledTableCell>
                    <StyledTableCell align="center">
                    ...
                    <StyledTableCell align="center">{}</StyledTableCell>
                    <StyledTableCell align="center">
                      {numberWithCommas(row.paperTotSleAmt)}
                    </StyledTableCell>
                    <StyledTableCell align="center">
                      {numberWithCommas(row.paperDcSleAmt)}
                    </StyledTableCell>
                    <StyledTableCell align="center">
                      {numberWithCommas(row.paperSleAmt)}
                    </StyledTableCell>
                    <StyledTableCell align="center">
                      {numberWithCommas(row.paperPdscAmt)}
                    </StyledTableCell>
                    <StyledTableCell align="center">
                      {numberWithCommas(row.paperCsbkAmt)}
                    </StyledTableCell>
                    <StyledTableCell align="center">
                      {numberWithCommas(row.paperGnrlAmt)}
                    </StyledTableCell>
                    <StyledTableCell align="center">
                      {numberWithCommas(row.totSleBdgtAmt)}
                    </StyledTableCell>
                    ...
                    <StyledTableCell align="center">
                      {numberWithCommas(row.totSleAmt)}
                    </StyledTableCell>
                    <StyledTableCell align="center">
                      {numberWithCommas(row.totDcAmt)}
                    </StyledTableCell>
                    <StyledTableCell align="center">
                      {numberWithCommas(row.afslBalAmt)}
                    </StyledTableCell>
                    <StyledTableCell align="center">
                      {numberWithCommas(row.dcSleBalAmt)}
                    </StyledTableCell>
                  </StyledTableRow>
                ))}
              </TableBody>
...
export default pbmntSttst;

pbmntSttst.getLayout = (page, navItems) => {
  return (
    <PrimaryLayout title={'상품권 발행 통계'} navItems={navItems}>
      {page}
    </PrimaryLayout>
  );
};
