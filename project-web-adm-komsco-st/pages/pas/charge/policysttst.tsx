...
const policySttst: NextPageWithLayout = () => {
  ...
  const fetchPolicyPayment = async () => {
    console.log('정책수당 지급 통계');
    ...
    console.log(params);
    GiftPolicyService.PolicyPayment(params).then((response: any) => {
      const data = response;
          ...
          <Table sx={{ minWidth: 800 }} aria-label="customized table">
            <TableHead>
              <TableRow>
                ...
                <StyledTableCell align="center">정책수당명</StyledTableCell>
                <StyledTableCell align="center">총 지급예산</StyledTableCell>
                <StyledTableCell align="center">지급건수</StyledTableCell>
              ...
              <TableBody>
                {items.map((row) => (
                  <StyledTableRow key={row.id}>
                    <StyledTableCell align="center">
                      {dateFormat(params.schTrmSrchDiv, row.prvsDt)}
                    </StyledTableCell>
                    <StyledTableCell align="center">
                    ...
                    <StyledTableCell align="center">
                      {numberWithCommas(row.bdgtAmt)}
                    </StyledTableCell>
                    <StyledTableCell align="center">
                      {numberWithCommas(row.prvsCcnt)}
                    </StyledTableCell>
                    <StyledTableCell align="center">
                      {numberWithCommas(row.prvsAmt)}
                    </StyledTableCell>
                    <StyledTableCell align="center">
                      {numberWithCommas(row.inlsBalAmt)}
                    </StyledTableCell>
                  </StyledTableRow>
                ))}
              </TableBody>
...
export default policySttst;

policySttst.getLayout = (page, navItems) => {
  return (
    <PrimaryLayout title={'정책수당 지급통계'} navItems={navItems}>
      {page}
    </PrimaryLayout>
  );
};
