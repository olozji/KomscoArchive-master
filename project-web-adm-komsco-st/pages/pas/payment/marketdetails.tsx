...
const Marketdetails: NextPageWithLayout = () => {
  ...
  const fetchMarketData = async () => {
    console.log('전통시장 결제내역 조회');
    GiftPolicyService.MarketPayment(params).then((response: any) => {
      const data = response;
  ...
  const saveSearchValue = async () => {
    ...
    giftPolicyService
      .RecentlySearchSave(lastSchParams)
      .then((res: any) => {
        //
              ...
              <TableBody>
                {items.map((row) => (
                  <StyledTableRow key={row.id}>
                    ...
                    <StyledTableCell align="center">
                      {numberWithCommas(row.gftcAmt)}
                    </StyledTableCell>
                    <StyledTableCell align="center">
                      {numberWithCommas(row.plcyAlowAmt)}
                    </StyledTableCell>
                    <StyledTableCell align="center">
                      {numberWithCommas(row.csbkAmt)}
                    </StyledTableCell>
                    <StyledTableCell align="center">
                      {numberWithCommas(row.setlAmt)}
                    </StyledTableCell>
...
Marketdetails.getLayout = (page, navItems) => {
  return (
    <PrimaryLayout title={'전통시장 결제내역'} navItems={navItems}>
      {page}
    </PrimaryLayout>
  );
};
