...
const CshmnInqry: NextPageWithLayout = () => {
  ...
  const fetchCashBackPayment = async () => {
    console.log('캐시백 월별 조회');
    GiftPolicyService.CashBackPayment(params).then((response: any) => {
      const data = response;
        ...
        <TableContainer component={Paper}>
          <Table sx={{ minWidth: 800 }} aria-label="customized table">
            <TableHead>
              ...
              <TableRow>
                <StyledTableCell align="center">적립건수</StyledTableCell>
                <StyledTableCell align="center">적립금액</StyledTableCell>
                <StyledTableCell align="center">회수건수</StyledTableCell>
                ...
                <StyledTableCell align="center">취소건수</StyledTableCell>
                ...
                {items.map((row) => (
                  <StyledTableRow key={row.id}>
                    <StyledTableCell align="center">
                      {dateFormat(params.schTrmSrchDiv, row.execDt)}
                    </StyledTableCell>
                    <StyledTableCell align="center">
                    ...
                    <StyledTableCell align="center">
                      {numberWithCommas(row.csbkInstlCcnt)}
                    </StyledTableCell>

                    <StyledTableCell align="center">
                      {numberWithCommas(row.csbkInstlAmt)}
                    </StyledTableCell>
                    <StyledTableCell align="center">
                      {numberWithCommas(row.csbkInstlRtrvCcnt)}
                    </StyledTableCell>
                    <StyledTableCell align="center">
                      {numberWithCommas(row.csbkInstlRtrvAmt)}
                    </StyledTableCell>
                    <StyledTableCell align="center">
                      {numberWithCommas(row.csbkSetlCcnt)}
                    </StyledTableCell>
                    <StyledTableCell align="center">
                      {numberWithCommas(row.csbkSetlAmt)}
                    </StyledTableCell>
                    <StyledTableCell align="center">
                      {numberWithCommas(row.csbkSetlRtrvCcnt)}
                    </StyledTableCell>
                    <StyledTableCell align="center">
                      {numberWithCommas(row.csbkSetlAmt)}
                    </StyledTableCell>
...
export default CshmnInqry;

CshmnInqry.getLayout = (page, navItems) => {
  return (
    <PrimaryLayout title={'캐시백 월별조회'} navItems={navItems}>
      {page}
    </PrimaryLayout>
  );
};
